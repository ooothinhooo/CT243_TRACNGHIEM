...
let questions = [
    {   
        question : "..... là một giai đoạn kiểm thử trong đó mô dun (đơn vị) riêng lẻ của một ứng dụng được kết hợp lại, giao tiếp dữ liệu giữa các mô dun này được kiểm tra",
        // imgSrc : "images/quiz/qblack.png",
        imgSrc : "https://media.ninecode.vn/api/files/view?id=1L928ZWJ",
    ...
    {   
        question : "Phát biểu nào đúng về mối quan hệ giữa sai sót (error), lỗi (defect), hỏng hóc (failure)",
        // imgSrc : "images/quiz/qblack.png",
        choiceA : "Tất cả đều đúng",
        choiceB : "Một lỗi (defect) có thể không bao giờ bị kích hoạt do người dùng không dùng đến hay do cần thiết xảy ra nên hỏng hóc (failure) chưa xảy ra",
        choiceC : "Các dòng mã bị sai có thể được chia sửa hoặc bị vô hiệu hoá bởi những dòng mã tiếp theo",
        choiceD : "Các dòng mã (code) bị sai sot có thể không ảnh hưởng đến chức năng phần mềm, tức không gây ra lỗi",
        correct : "A"
    },
    {   
        question : "Kiểm thử nào không được thử hiện mã lệnh (không chạy chương trình)",
        // imgSrc : "images/quiz/qblack.png",
    ...
    {   
        ...
        // imgSrc : "images/quiz/qblack.png",
        choiceA : "Khó thưc hiện các tính toán phức tạp, ít khả năng tái sử dụng tốn nhiều thời gian kiểm thử, dễ sai sót hoặc nhầm lẫn của con người cần nhiều nhân lực hơn",
        choiceB : "Cần ít nhân lực có khả năng tái sử dụng, tăng mức độ bao phủ (test coverage) trong thời gian kiểm thử ngắn hơn, có độ tin cậy cao, có thể thự hiện song song nhiều ca kiểm thử (test case) nhanh",
        choiceC : "tất cả đều sai",
        choiceD : "Tốn thời gian phát biểu và bảo trì dự án kiểm thử, tốn chi phí mua công cụ (phần mềm kiểm thử ) cần cài đặt môi trường kiếm thử, sửa lỗi (gỡ rồi} cho tập lệnh kiểm thứ (test script) là vấn đề khó khăn ",
        correct : "B"
    },
    {   
        question : "Chưa có đáp án) Tại sao kiểm thử tăng trưởng (incremetal testing) đc yêu thích hơn kiểm thử big bang",
        // imgSrc : "images/quiz/qblack.png",
        choiceA : "Thích hợp cho dự án nhỏ",
        choiceB : "Phải thực hiện nhiêu công việc hơn để kiểm thử một chương trình",
        choiceC : "Tất cả đều sai",
        choiceD : "Bởi vì kiểm thử tăng trưởng có khả năng sớm phát hiện, sàng lọc và cách ly lỗi tốt hơn",
        correct : "D"
    },
    {   
    ...
    {   
        ...
        choiceB : "Phân vũng tương đương, phần tích giá trị biên, bảng quyết định, đõ thị chuyến đối trạng thải, và đoán lỗi",
        choiceC : "Bao phú vỗng lặp, bao phủ đưỡng đi cơ bản",
        choiceD : "Bao phù điều kiện, bao phú quyết định đa điều kiện",
        correct : "B"
    },
    {   
        question : "Tai sao kiếm thừ tăng trưởng (Incremental testing] được yêu thích hơn kiếm thử Big Bang",
        // imgSrc : "images/quiz/qblack.png",
        choiceA : "Phải thực hiện nhiều công việc hơn đế kiếm thứ một chương trỉnh",
        choiceB : "Tất cả đều sai",
        choiceC : " Bởi vị kiếm thử tăng trưởng có khả năng sớm phát hiện, sảng lọc vả cách ly lỗi tốt hơn",
    ...
    {   
        ...
        // imgSrc : "images/quiz/qblack.png",
        choiceA : "Kiếm thử hệ thống xem nó có vận hành tốt khi tích hợp với các hệ thống khác",
        choiceB : "Tìm lỗi trong hệ thống",
        choiceC : "Đảm bảo rằng hệ thống có thể chấp nhận được đổi với tất cả người dùng",
        choiceD : "Kiếm thử theo quan điểm công việc (xem các chức năng có đáp ứng công việc thực tế của người dùng thật sự không)",
        correct : "D"
    },
    {   
        question : "Theo IEEE, đâu không phải là mảng hoạt đông của đảm bảo chất lượng (SQA}?",
        // imgSrc : "images/quiz/qblack.png",
